...
import frc.robot.commands.PlaceAndLeaveAuto;
import frc.robot.commands.PlaceAndParkAuto;
...
public class Robot extends TimedRobot {
  ...
  private static final String kDefaultAuto = "Place and Park";
  private static final String kplaceLeavePark = "Place Leave Park";
  ...
  public void robotInit() {
    ...
    m_chooser.setDefaultOption("Place and Park", kDefaultAuto);
    m_chooser.addOption("Place Leave Park", kplaceLeavePark);
  ...
  public void robotPeriodic() {
    ...
    if (SmartDashboard.getBoolean("Enable Compressor Analog", false)) {
      ...
      double maxPressure =
          SmartDashboard.getNumber("Maximum Pressure (PSI)", 120.0);
  ...
  public void autonomousInit() {
    ...
    if(m_chooser.getSelected().equals("Place and Park")) {
      m_autonomousCommand = new PlaceAndParkAuto(m_robotContainer);
    }
    else if(m_chooser.getSelected().equals("Place Leave Park")) {
      m_autonomousCommand = new PlaceAndLeaveAuto(m_robotContainer);
    }
