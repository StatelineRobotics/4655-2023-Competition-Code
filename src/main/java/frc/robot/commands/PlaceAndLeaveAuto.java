...
public class PlaceAndLeaveAuto extends SequentialCommandGroup{

    public PlaceAndLeaveAuto(RobotContainer robotContainer) {
        ...
        PathPlannerTrajectory path = PathPlanner.loadPath("Place and Leave", new PathConstraints(3, 3));
